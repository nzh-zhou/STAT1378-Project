...
If you are reading this, then you must have downloaded and installed my package. The function `mytest` does the whole statistical test for a specific question like what I have done in this report. Run `?project::mytest` for more details.
